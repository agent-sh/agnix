...
- [CONTRIBUTING.md](https://github.com/agent-sh/agnix/blob/v0.37.5/CONTRIBUTING.md) - full contribution guidelines
- [SECURITY.md](https://github.com/agent-sh/agnix/blob/v0.37.5/SECURITY.md) - security policy
