...
- [knowledge-base/rules.json](https://github.com/agent-sh/agnix/blob/v0.37.5/knowledge-base/rules.json)
- [knowledge-base/VALIDATION-RULES.md](https://github.com/agent-sh/agnix/blob/v0.37.5/knowledge-base/VALIDATION-RULES.md)
