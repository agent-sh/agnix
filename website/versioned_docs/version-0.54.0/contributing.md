...
agnix validates against 456 rules, but the agent config ecosystem moves fast. If a rule is wrong, missing, or too noisy, I want to know.
...
- [CONTRIBUTING.md](https://github.com/agent-sh/agnix/blob/v0.54.0/CONTRIBUTING.md) - full contribution guidelines
- [SECURITY.md](https://github.com/agent-sh/agnix/blob/v0.54.0/SECURITY.md) - security policy
