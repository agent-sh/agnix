...
- [CONTRIBUTING.md](https://github.com/agent-sh/agnix/blob/v0.50.0/CONTRIBUTING.md) - full contribution guidelines
- [SECURITY.md](https://github.com/agent-sh/agnix/blob/v0.50.0/SECURITY.md) - security policy
