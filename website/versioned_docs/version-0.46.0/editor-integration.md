...
[VS Code extension README](https://github.com/agent-sh/agnix/tree/v0.46.0/editors/vscode).
...
For details, see the
[JetBrains plugin README](https://github.com/agent-sh/agnix/tree/v0.46.0/editors/jetbrains).
...
[Zed extension README](https://github.com/agent-sh/agnix/tree/v0.46.0/editors/zed).
...
[docs/EDITOR-SETUP.md](https://github.com/agent-sh/agnix/blob/v0.46.0/docs/EDITOR-SETUP.md).
