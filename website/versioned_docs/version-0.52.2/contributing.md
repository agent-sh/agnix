...
agnix validates against 455 rules, but the agent config ecosystem moves fast. If a rule is wrong, missing, or too noisy, I want to know.
...
- [CONTRIBUTING.md](https://github.com/agent-sh/agnix/blob/v0.52.2/CONTRIBUTING.md) - full contribution guidelines
- [SECURITY.md](https://github.com/agent-sh/agnix/blob/v0.52.2/SECURITY.md) - security policy
